...
const Return = () => {
  ...
  const [activeComponent, setActiveComponent] = useState("return"); // State to track active component
  ...
  return (
    <div className="relative pt-5 margin_for_header">
      <div className="sub-section">
        ...
        <section className="grid grid-cols-12 max-lg:grid-cols-8 gap-2 place-items-start relative z-10 transition-all duration-500 ease-in-out pt-3">
      ...
      <img
        src={dottcircle}
        className=" absolute right-28 -z-10 top-[6%]  max-md:hidden"
        alt=""
      />
      <img
        src={circle}
        className=" absolute -right-12  top-[4%] max-md:hidden"
        alt=""
      />
      <img
        src={circle}
