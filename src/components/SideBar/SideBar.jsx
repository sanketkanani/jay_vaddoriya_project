...
function SideBar({
  ...
  const isQuizTestPage = currentPath.includes("quiz");
  ...
  const DesktopMenu = () => (
    <div className="sidebar p-5">
      <div className="flex flex-col h-full justify-between">
        ...
        <div className=" py-3 rounded-2xl bg-white shadow-[0px_5px_25px_0px_rgba(59,154,168,0.15)] ">
          <div className="flex justify-center items-center">
            <div
              className="flex justify-center items-center user-image"
              style={{
                background: `url(/images/sidebarsvgs/user-effect.svg) `,
              }}
            >
