    ...
    return (
      <div className="lectures-info sm:px-3 sm:!w-6/12 !w-full h-full">
        ...
        <div className="ongoing-container py-2 px-4">
          <div className="ongoing-container-header justify-between !p-0">
            <span className="ongoing-container-header-title text-start">
              {course}
            </span>
          ...
          <div className="flex flex-col">
            <span className="ongoing-container-field text-start">
              Topic:&nbsp;
            ...
            <div className="ongoing-container-field extra-btns text-start">
              <span>
                Venue:&nbsp;
                <span className="ongoing-container-field-bold">
    ...
    return (
      <div className="lectures-info sm:px-3 sm:!w-6/12 !w-full h-full">
        ...
        <div className="upcoming-container py-2 px-4">
          <div className="ongoing-container-header !p-0">
            <span className="upcoming-container-header-title text-start">
              {course}
            </span>
            <span className="ongoing-container-header-online-icon">
              <svg
