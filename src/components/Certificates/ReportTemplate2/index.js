...
import './index3.css'
const ReportTemplate3 = ({ info }) => {
  return (
    <>
      <div id="certificate2" class="main_bg_start1">
          ...
          <tbody>
            ...
            <tr style={{ textAlign: 'center' }}>
              <td colSpan="3" style={{
                ...
                for completing the <strong> Course on {info?.course_name} <br /> in {info?.certificateYear}</strong>.
              </td>
            </tr>
            <tr>
              <td height="40px"></td>
