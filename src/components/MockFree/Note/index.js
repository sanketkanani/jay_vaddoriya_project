                ...
                <Layout isDisabled={is_disable} tag={tag} key={idx}>
                  <div className={`note-card ${disabledClass}-card`}>
                    ...
                    <div className="note-content relative !pe-10">
                      ...
                      <span className="text-gray-700 text-base text-start  font-semibold mb-1">
                        {name}
                      </span>
                      <div className="topic-wrapper">
                        <div className="flex">
                          ...
                          {topic ? (
                            <span className="text-gray-700 text-start text-base font-medium">
                              {topic}
                            </span>
                          ) : (
                      ...
                      {!file || !topic ? (
                        <span className="inline-block mt-2 py-1 px-1 text-red-500 border border-solid border-red-100 rounded-md bg-red-50 ">
