...
const Mock = ({ setScreen, courseId, setWeek }) => {
  ...
  const fetchData = async () => {
    ...
    if (loggedIn) {
      const apiUrl = `${ApiBaseURL}free-course-management/mock-question-lock-status/?course_id=${courseId}`;
                  ...
                  >
                    <div className="relative z-10">
                      ...
                      <div className="course-body">
                        {path ? (
                          <img alt={sectionText} src={DemoImage} />
                        ) : (
                          <img alt={sectionText} src={DemoImage} />
                        )}
                        ...
                        <div className="course-progress">
                          ...
                          >
                            ...
                            <span className="total">{maximum_attempts}</span>
                          </div>
