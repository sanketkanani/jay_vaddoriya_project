...
function ProfileCard() {
  ...
  useEffect(() => {
    if (loggedIn) {
      fetch(
        `${ApiBaseURL}free-course-management/student-profile-free-course/`,
        {
          method: "GET",
          headers: {
        ...
        .then((data) => {
          ...
          const { profile_data, course_data } = data || {};
          // const {
          //   user,
          //   message,
          //   user__first_name,
          ...
          setUserProfile({
            firstName: profile_data[0]?.user__first_name || "",
            lastName: profile_data[0]?.user__last_name || "",
            email: profile_data[0]?.user__email || "",
            phoneNum: profile_data[0]?.phone_num || "",
            profilePic: profile_data[0]?.profile_img || null,
            Stud_course_details: course_data || [],
          });
        })
  ...
  return (
    <div className="card p-5 rounded-xl bg-white shadow-[0px_5px_25px_0px_rgba(62,144,156,0.10)]">
      <div className="student-card relative">
        <div className="student-info flex gap-3 items-center pb-5 border-b border-solid border-[#A4C3C8">
          {!userProfile?.profilePic ? (
            ...
            <div>
              <img
                src={userProfile?.profilePic ?? DemoImage}
                alt="student banner"
                style={{ width: "100px", height: "100px" }}
              />
            </div>
          ...
          <div className="w-full px-3">
            {userProfile?.Stud_course_details &&
              ...
              userProfile?.Stud_course_details.map((course, index) => (
                ...
                >
                  <div className="flex flex-wrap -mx-3 ">
                    <div class="md:w-6/12 w-full px-3 pr-0">
                    ...
                    <div class="md:w-4/12 w-full px-3 pl-0">
                      <div>
                        ...
                        <div className="flex mb-3 px-3">
                          ...
                          <span className="value text-gray-700 text-base font-medium ml-2 whitespace-nowrap">
                            {formatDate(course.end_date) || "Ongoing"}
                          </span>
                        </div>
                      </div>
                    </div>
